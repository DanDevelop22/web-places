...
const MarkerCustom: React.FC<MarkerCustomProps> = ({ place, onClick, isSelected }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'w-12 h-12 rounded-full border-2 border-white shadow-lg flex items-center justify-center transition-all duration-200',
          isSelected
      ...
      <div
        className={clsx(
          'absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-900 text-white text-sm rounded-lg whitespace-nowrap opacity-0 transition-opacity duration-200 pointer-events-none',

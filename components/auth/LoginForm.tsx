    ...
    <div className="w-full max-w-md mx-auto">
      <div className="card-brand p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-brand-dark-900 dark:text-brand-dark-100 mb-2">Iniciar Sesión</h2>
          <p className="text-brand-dark-600 dark:text-brand-dark-300">Accede a tu cuenta</p>
        </div>
        ...
        <div className="mt-4 text-center">
          <button
            ...
            className="text-xs text-brand-dark-500 dark:text-brand-dark-300 hover:text-brand-dark-700 dark:hover:text-brand-dark-100 underline mr-4"
          >
          ...
          <button
            ...
            className="text-xs text-brand-dark-500 dark:text-brand-dark-300 hover:text-brand-dark-700 dark:hover:text-brand-dark-100 underline"
          >
